...
@Component
public class GetAnnotationBeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        if(beanClass.isAnnotationPresent(Api.class)){
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        return Proxy.newProxyInstance(
                ...
                (proxy, method, args) -> {
                    System.out.println("BEAN_CLASS");
                    Method originalMethod = bean.getClass().getMethod(method.getName(), method.getParameterTypes());
                    EventBus annotation = originalMethod.getDeclaredAnnotation(EventBus.class);
